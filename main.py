...
sched.add_job(blink_reminder, 'interval', seconds = 60)
sched.start()
...
def main():
    ...
    print("[INFO] press r to reset counter, q to quit...")
    ...
    while True:
        ...
        # if the `r` key was pressed, reset the total count
        if key == ord("r"):
            TOTAL = 0
